...
import online_groceries_pana from "../../components/Assets/Online Groceries-pana (1) 1.png";
  ...
  return (
    <section className='w-10/12 mx-auto mt-6 gap-4 md:w-7/12 md:mx-auto md:flex  md:flex-col  md:justify-center md:py-0 md:gap-2'>
      ...
      <div className='flex items-center justify-center'>
        <img src={online_groceries_pana} alt='' className='w-52 h-[347px]' />
      </div>
